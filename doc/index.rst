...
install **psiTurk**. Instructions can be found on the `Getting psiTurk installed on your computer <install.html>`__ page. Afterwards, head over to `Quickstart <https://www.psiturk.org/quick_start>`__ , 
