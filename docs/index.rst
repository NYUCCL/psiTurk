...
install **psiTurk**. Instructions can be found on the `Getting psiTurk installed on your computer <install.html>`__ page. Afterwards, head over to `Quickstart <https://www.psiturk.org/quick_start>`__ , or for a more detailed tutorial demonstrating how to
setup a simple experiment with **psiTurk**, visit `Getting up and
running with the basic Stroop task <>`__.
