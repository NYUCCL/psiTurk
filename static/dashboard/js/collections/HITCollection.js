    ...
    return HITs = (function(_super) {
      ...
      function HITs() {
        ...
        this.fetch = function(options) {
          return HITs.prototype.fetch.apply(_this, arguments);
        };
        this.count = function() {
          return HITs.prototype.count.apply(_this, arguments);
        };
        return HITs.__super__.constructor.apply(this, arguments);
      }
